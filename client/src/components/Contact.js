import {Center, Input, Button, Textarea, FormControl, VStack, Text, Skeleton} from '@chakra-ui/react'
    ...
    return (
        <Center>
            ...
            <VStack spacing='1.5rem'>
                ...
                <Skeleton isLoaded={!props.sending}>
                <Input placeholder="your email address" type="email" name="reply_to"/>
                </Skeleton>
                <Skeleton isLoaded={!props.sending}>
